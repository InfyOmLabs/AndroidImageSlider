...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        mDefaultSelectedColor = attributes.getColor(R.styleable.PagerIndicator_selected_color, Color.rgb(0, 0, 0));
        mDefaultUnSelectedColor = attributes.getColor(R.styleable.PagerIndicator_unselected_color, Color.rgb(220,220,220));
